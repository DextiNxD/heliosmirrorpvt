...
try:
    ...
    if len(GD_INFO) == 0:
        GD_INFO = 'Uploaded by NTudum Mirror Bot'
except KeyError:
    GD_INFO = 'Uploaded by NTudum Mirror Bot'
...
try:
    ...
    if len(TITLE_NAME) == 0:
        TITLE_NAME = 'NTudum-Mirror-Search'
except KeyError:
    TITLE_NAME = 'NTudum-Mirror-Search'
...
try:
    ...
    if len(AUTHOR_URL) == 0:
        AUTHOR_URL = 'https://t.me/NTudumRss'
except KeyError:
    AUTHOR_URL = 'https://t.me/NTudumRss'
